    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        already.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ShopkeeperLoginActivity.this,RegisterUserActivity.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ShopkeeperLoginActivity.this, "Login successful", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ShopkeeperLoginActivity.this, MainActivity.class));
                            finish();
                        } else {
                            Toast.makeText(ShopkeeperLoginActivity.this, "Login failed. Please check your email and password.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
